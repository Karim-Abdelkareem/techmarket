      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted destination for the latest electronic devices and accessories. Quality products, competitive prices, exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Smartwatches</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center">
                ...
                123 example address, City, country 12345
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-center">
            © {new Date().getFullYear()} TechMarket. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
