...
export default function AddAudioForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      console.log('Submitting audio device data...');
      ...
      if (!response.ok) {
        ...
        throw new Error(`Failed to add audio device: ${errorData.message || response.statusText}`);
      }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-8xl mx-auto p-6 bg-white shadow-md rounded-lg space-y-6">
      <h2 className="text-2xl font-semibold text-gray-700 mb-4">Add New Audio Device</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          ['Noise Cancellation', 'noiseCancellation', 'checkbox'],
          ['Microphone', 'microphone', 'checkbox'],
          ['Water Resistant', 'waterResistant', 'checkbox'],
