...
const AddDealerForm = ({ onSuccess, onCancel }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || 'Failed to create dealer');
      }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-800">Add New Dealer</h2>
